...
#define DEFAULT_MODE                MAX30100_MODE_HRONLY  // HRONLY just uses the IR LED. 
#define DEFAULT_SAMPLING_RATE       MAX30100_SAMPRATE_200HZ
#define DEFAULT_PULSE_WIDTH         MAX30100_SPC_PW_1600US_16BITS
#define DEFAULT_RED_LED_CURRENT     MAX30100_LED_CURR_4_4MA  // low power
#define DEFAULT_IR_LED_CURRENT      MAX30100_LED_CURR_50MA
#define EXPECTED_PART_ID            0x11
#define RINGBUFFER_SIZE             16

#define I2C_BUS_SPEED               100000UL        // 400000UL for short wire leads, 100000UL for long leads
